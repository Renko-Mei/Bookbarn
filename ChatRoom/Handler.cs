...
namespace final_project
{
    public abstract class Handler
    {
        ...
        public Handler(ConnectionManager webSocketConnectionManager)
        {
        ...
        public virtual async Task OnDisconnected(WebSocket socket)//这个可能用不到
        {
        ...
        {
            if(socket.State != WebSocketState.Open) //这个以后可以改
                return;
        ...
        public async Task SendMessageToAllAsync(string message)//这个应该用不到
        {
